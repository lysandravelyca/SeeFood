        ...
        tenants = [
            ...
            "GOP 6": [
                ...
                Tenant(name: "Nasi Kapau", image: "NK", menuItems: [
                    ...
                    MenuItem(image: "NK1", name: "Rendang Daging", des: "Daging sapi dengan bumbu khas Minang.", price: "Rp 35.000"),
            ...
            "The Breeze": [
                Tenant(name: "RM Padang Salero", image: "RM", menuItems: [
                    ...
                    MenuItem(image: "RM-4", name: "Ayam Pop", des: "Ayam rebus dengan sambal merah", price: "Rp 17.000"),
                    MenuItem(image: "RM-3", name: "Gulai Tunjang", des: "Kikil sapi dengan kuah santan", price: "Rp 15.000")
                ...
                Tenant(name: "Nasi Kapau Bundo Kito", image: "NKA", menuItems: [
                    ...
                    MenuItem(image: "NKA-2", name: "Gulai Tambusu", des: "Usus sapi dengan isi tahu dan telur", price: "Rp 12.000"),
                    MenuItem(image: "NKA-1", name: "Ikan Asam Padeh", des: "Kopi susu segar", price: "Rp 15.000"),
                    MenuItem(image: "NKA-4", name: "Dendeng Batokok", des: "Kopi susu gula aren", price: "Rp 17.000"),
                    MenuItem(image: "NKA-3", name: "Sayur Kapau", des: "Coklat dengan susu segar", price: "Rp 15.000")
